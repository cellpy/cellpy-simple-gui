...
## Corpus Check
- 43 files · ~150,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6646 nodes · 20495 edges · 302 communities (212 shown, 90 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 859 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ef62933c`
...
- `test_group_average_singleton_traces_on_correct_facet()` --calls--> `Library`  [INFERRED]
  tests/test_core.py → src/cellpy_simple_gui/core/library.py

## Communities (302 total, 90 thin omitted)

### Community 0 - "$"
Cohesion: 0.02
Nodes (97): addLayer(), addSprite(), bc(), completeTask(), _createCanvas(), _down(), draw(), gc() (+89 more)
...
### Community 5 - "Si"
Cohesion: 0.1
Nodes (4): getCanvas(), getCanvasContainer(), isZooming(), Si()

### Community 6 - "eu"
Cohesion: 0.02
Nodes (59): an(), Be(), bn(), Br(), cn(), cr(), Dn(), dr() (+51 more)

### Community 7 - "cells.py"
Cohesion: 0.08
Nodes (40): BaseModel, CellMeta, CellsExportSpec, ExportSpec, IngestExampleRequest, IngestRequest, JournalRowUpdate, LoadExampleRequest (+32 more)

### Community 8 - ".constructor"
Cohesion: 0.02
Nodes (66): $, addControl(), Ao(), bc(), bh(), clearMetrics(), _createDelegatedListener(), Dc() (+58 more)
...
Cohesion: 0.11
Nodes (3): Vi(), setMaxPitch(), setMinPitch()

### Community 15 - ".createVertexBuffer"
Cohesion: 0.04
Nodes (58): _(), a(), ar(), at(), b(), c(), ce(), ct() (+50 more)

### Community 16 - "_restyle"
Cohesion: 0.01
Nodes (29): Ai(), bi(), ci(), constructor(), _createButton(), getCanvas(), getCanvasContainer(), getContainer() (+21 more)

### Community 17 - ".get"
Cohesion: 0.07
Nodes (7): eu(), Fu(), gt(), jt(), stream(), wt(), yt()
...
### Community 22 - ".push"
Cohesion: 0.03
Nodes (24): dt(), _t(), ae(), au(), Be(), bt(), ct(), finish() (+16 more)

### Community 23 - "get_settings"
Cohesion: 0.04
Nodes (65): create_app(), FastAPI application factory., Shared dependencies: templates and the local-token guard., Guard API routes. The index page plants the token as a cookie; the     frontend, require_token(), BaseSettings, get_settings(), Application settings and paths. (+57 more)

### Community 25 - "ft"
Cohesion: 0.08
Nodes (4): getGlyphs(), getLight(), setLight(), showCollisionBoxes()

### Community 26 - "s"
Cohesion: 0.05
Nodes (75): A(), B(), C(), d(), H(), J(), P(), R() (+67 more)
...
Cohesion: 0.02
Nodes (33): aa(), addControl(), addImage(), addSource(), _createDelegatedListener(), de(), _diffStyle(), getFeatureState() (+25 more)
...
### Community 33 - "vn"
Cohesion: 0.03
Nodes (15): _t(), ae(), ah, bt(), feature(), Le(), oh(), pop() (+7 more)

### Community 34 - "ur"
Cohesion: 0.04
Nodes (15): cr(), dr(), fr(), gr(), jr(), lr(), nr(), sr() (+7 more)

### Community 36 - "ye"
Cohesion: 0.04
Nodes (6): Dt(), ft(), ht(), oi(), Pt(), th()
...
### Community 38 - ".set"
Cohesion: 0.03
Nodes (34): An(), an(), bn(), cn(), di(), Dn(), En(), fi() (+26 more)
...
### Community 40 - "Dt"
Cohesion: 0.04
Nodes (11): ch(), Dt(), ee(), eh(), ft(), ht(), onRemove(), Pt() (+3 more)
...
Cohesion: 0.06
Nodes (50): load_journal_cells(), Load a cellpy batch journal (.json) and return ``(label, cell, group)``., RuntimeError, api/jobs.py, Cancelled, _DaemonThreadPoolExecutor, get_job_manager(), Job (+42 more)
...
### Community 47 - "r"
Cohesion: 0.08
Nodes (7): _down(), _getMapId(), getSource(), r(), ua(), _up(), ve()
...
Cohesion: 0.04
Nodes (17): al(), bl(), cu(), eu(), Fu(), hu(), il(), jl() (+9 more)
...
Cohesion: 0.05
Nodes (12): Fl(), Go(), Hl(), ho(), ji(), mc(), Ns(), qi() (+4 more)
...
Cohesion: 0.09
Nodes (26): Library, Any, Add a cell while preserving saved organisational metadata. Physical quantities…, Thread-safe ordered collection of :class:`CellRecord`., core/projects.py, CellEntry, classify_import_path(), delete_project() (+18 more)

### Community 66 - "Br"
Cohesion: 0.08
Nodes (31): bs(), cl(), cs(), ds(), el(), Es(), fs(), gs() (+23 more)
...
Cohesion: 0.06
Nodes (27): addLayer(), addSprite(), getSky(), isMoving(), isRotating(), isSourceLoaded(), isStyleLoaded(), _lazyInitEmptyStyle() (+19 more)
...
### Community 72 - "de"
Cohesion: 0.09
Nodes (7): addImage(), de(), getLayer(), getLayoutProperty(), listImages(), removeFeatureState(), removeImage()
...
### Community 75 - "rh"
Cohesion: 0.05
Nodes (30): ar(), B(), Ce(), ct(), d(), dt(), ei(), Fn() (+22 more)

### Community 76 - "Oc"
Cohesion: 0.06
Nodes (13): _containerDimensions(), _getClampedPixelRatio(), ka, la(), ma, pa(), resize(), _resizeCanvas() (+5 more)

### Community 77 - "conftest.py"
Cohesion: 0.06
Nodes (32): cellpy-simple-gui: a simple desktop GUI for exploring battery data with cellpy., CellRecord, Library, Add a cell while preserving saved organisational metadata.          Physical qua, A loaded cell plus its mutable, user-editable metadata., Thread-safe ordered collection of :class:`CellRecord`., CellEntry, classify_import_path() (+24 more)
...
### Community 85 - "ti"
Cohesion: 0.04
Nodes (21): ci(), completeTask(), constructor(), _createButton(), _createCanvas(), hi(), Li(), mr() (+13 more)
...
Cohesion: 0.07
Nodes (40): e2e, LogRecord, FastAPI application factory., Shared dependencies: templates and the local-token guard., Guard API routes. The index page plants the token as a cookie; the frontend…, require_token(), get_settings(), Path (+32 more)
...
### Community 94 - "ge"
Cohesion: 0.06
Nodes (13): Ao(), bo(), Co(), Eo(), jo(), ko(), Lo(), Mo() (+5 more)
...
Cohesion: 0.04
Nodes (109): FigureExportError, Static figure export failed (often missing kaleido)., CyclesPlotSpec, IcaPlotSpec, Drives a cellpy ``collect_ica`` collection for one cell (Cell explorer)., Drives a cellpy ``collect_summaries`` collection + its plot/export., Drives a cellpy ``collect_cycles`` collection.      With ``cell_id`` set: one, SummaryPlotSpec (+101 more)

### Community 104 - "cellpy_adapter.py"
Cohesion: 0.06
Nodes (51): DataFrame, _load_files_job(), capacity_curve(), cellpy_version(), example_raw_path(), export_cell_csv(), export_cell_excel(), _get() (+43 more)
...
Cohesion: 0.02
Nodes (140): _apply_colorway(), _apply_share_y(), _apply_y_ranges(), _axis_key_to_id(), _batch(), _capacity_mode_from_column(), combined_summary_frame(), cycles_collection() (+132 more)
...
### Community 135 - "Ei"
Cohesion: 0.07
Nodes (6): calculateCameraOptionsFromTo(), _cancelRenderFrame(), Ei(), project(), _requestRenderFrame(), unproject()
...
Cohesion: 0.14
Nodes (23): get_library(), Return the process-wide library singleton., clear(), delete_cell(), get_state(), load_example(), _load_examples_job(), _load_files_job() (+15 more)
...
Cohesion: 0.13
Nodes (38): HTTPException, routers/export.py, _check_data_fmt(), _check_figure_fmt(), _check_fmt(), _cycles_records(), export_cells(), export_cycles() (+30 more)

### Community 212 - ".possiblyEvaluate"
Cohesion: 0.13
Nodes (3): Ei(), setMaxZoom(), setMinZoom()
...
Cohesion: 0.11
Nodes (16): bh(), ch(), dh(), du(), fh(), gh(), hh(), jh (+8 more)
...
Cohesion: 0.12
Nodes (20): _batch(), combined_summary_frame(), cycles_collection(), _filter_ica_by_direction(), _has_right_facet_strips(), ica_collection(), partition_by_group_size(), Bridge the in-memory library into cellpy's own collect / plot / export stack. (+12 more)
...
Cohesion: 0.18
Nodes (21): _(), a(), C(), en(), It(), ki(), Kt(), l (+13 more)
...
### Community 230 - "Xt"
Cohesion: 0.04
Nodes (16): Yt(), ah, feature(), fo(), getFeatureState(), hc(), iu(), jo() (+8 more)

### Community 231 - "Je"
Cohesion: 0.18
Nodes (20): ci(), cn(), deleteProperty(), ge(), get(), has(), ii(), Ir() (+12 more)
...
Cohesion: 0.13
Nodes (4): aa(), addSource(), onAdd(), _updateStyle()
...
Cohesion: 0.12
Nodes (5): As(), hc(), Os(), Po(), Yl()

### Community 240 - "Community 240"
Cohesion: 0.15
Nodes (16): Bn(), dr(), Et(), Gi(), jr(), lr(), pe(), R() (+8 more)
...
Cohesion: 0.17
Nodes (15): Ae(), E(), fe(), fr(), Gt(), he(), Ji(), ke() (+7 more)
...
Cohesion: 0.15
Nodes (8): _containerDimensions(), _getClampedPixelRatio(), ma, resize(), _resizeCanvas(), setPixelRatio(), _setupContainer(), ya

### Community 248 - "Community 248"
Cohesion: 0.21
Nodes (14): _apply_share_y(), _empty_figure_json(), figure_json(), figures_json(), _inject_app_chrome(), is_grouped(), True when the collection carries averaged (mean/std) series., True when the caller asked for shared facet y-scales (``share_y`` wins). (+6 more)
...
Cohesion: 0.18
Nodes (11): br(), er(), Gn(), gr(), Hi(), hn(), J(), Ln() (+3 more)
...
Cohesion: 0.2
Nodes (10): _apply_y_ranges(), _layout_key_for_y_id(), Map facet ``variable`` → ``(xaxis_id, yaxis_id)`` from base traces.      Prefe, Pull ``variable=<name>`` from a PX hovertemplate, if present., Align a secondary figure's facet ids with the base figure's variables., Plotly layout key for a trace ``yaxis`` id (``y`` → ``yaxis``, …)., Set per-facet ``[lo, hi]`` on the merged summary figure (#60 / #54).      Pref, _remap_trace_axes() (+2 more)

### Community 263 - "Community 263"
Cohesion: 0.25
Nodes (3): Core layer: pure-Python domain logic for cellpy-simple-gui.  Nothing in this pac, In-memory library of loaded cells — the backend's source of truth.  For a single, Figure generation — thin delegation to cellpy's own collect + plotting.  We no
...
Cohesion: 0.4
Nodes (4): _apply_colorway(), _hex_to_rgba(), Turn ``#RRGGBB`` into ``rgba(r,g,b,a)`` for translucent Plotly fills., Cycle a discrete colorway across legend series (name / legendgroup).
...
Cohesion: 0.4
Nodes (5): _preserve_full_name_on_hover(), Keep the full identity discoverable when display ``name`` is truncated.      P, Truncate long legend-facing labels; return longest *displayed* length.      Jo, _shorten_legend(), _truncate_label()

### Community 294 - "Community 294"
Cohesion: 0.5
Nodes (4): export_bytes(), export_frame_bytes(), Serialise a tidy polars frame in-memory. Returns (bytes, media_type)., Serialise a collection's tidy frame in-memory. Returns (bytes, media_type).

## Knowledge Gaps
- **938 isolated node(s):** `Application settings and paths.`, `Desktop shell: run the local app inside a native window via pywebview.`, `Destroy open windows so webview.start() can return.`, `Make Ctrl+C close the native window (SIGINT alone often never fires in the GUI l`, `Stop jobs + uvicorn so the process can exit and free the terminal.` (+933 more)
...
- **Why does `expand_paths()` connect `expand_paths` to `cellpy_adapter.py`, `get_job_manager`, `cells.py`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `de()` connect `.preventDefault` to `$`, `vn`, `ye`, `eu`, `mt`, `.createVertexBuffer`, `Community 242`, `Community 280`, `a`, `.constructor`?**
