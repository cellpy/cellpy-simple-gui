...
```python
cellpy.filefinder.find_in_raw_file_directory(raw_file_dir: cellpy.internals.otherpath.OtherPath | pathlib.Path, str, NoneType = None, project_dir: cellpy.internals.otherpath.OtherPath | pathlib.Path, str, NoneType = None, extension: str | None = None, glob_txt: str | None = None, allow_error_level: int | None = 3)
```
